...
initMenu();
				...
				JButton bt6 = new JButton("장바구니의 항목 삭제하기",
						...
						bt6.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								...
								if (mCart.mCartCount == 0)
									JOptionPane.showInternalMessageDialog(bt3,"장바구니에 항목이 없습니다","장바구니 비우기", JOptionPane.ERROR_MESSAGE);
								else {
									mPagePanel.removeAll();
	...
	menu04.setFont(ft);
	JMenuItem item07 = new JMenuItem("상품 목록");
	menu04.add(item07);
	menuBar.add(menu04);
	setJMenuBar(menuBar);
